...
extension String {
    static func size(withText text:String, withFont font:UIFont, andMaxSize maxSize:CGSize) -> CGSize {
        return NSString(string: text).boundingRectWithSize(maxSize, options: .UsesLineFragmentOrigin, attributes: [NSFontAttributeName: font], context: nil).size
    }
